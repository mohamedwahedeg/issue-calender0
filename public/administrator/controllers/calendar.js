angular.module('calendar', []).controller('calendar', function ($rootScope, $location, Auth, $scope, $http, $window, issuedetails, report_today_data, moment, calendarConfig) {
    ...
    if ($window.localStorage["user"]) {
        ...
        //            }
        //            /////
        $scope.open_issue = function (Discount_Name, Discount_Position, circle, claim_no, court, issue_Notes, issue_decision_t, last_session, last_session_reason, next_session, subject, u_area_no, u_id, issue_id, u_firstname, area_name,court_type,mokem_el_issue) {
                issuedetails.set(Discount_Name, Discount_Position, circle, claim_no, court, issue_Notes, issue_decision_t, last_session, last_session_reason, next_session, subject, u_area_no, u_id, issue_id, u_firstname, area_name, court_type, mokem_el_issue);
