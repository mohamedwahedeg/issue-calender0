angular.module('reports0', []).controller('reports0', function ($rootScope, $location, Auth, $scope, $http, $window) {
    ...
    $scope.submit11 = function (valuee, from, to) {
            ...
            if (from === undefined || from === null || to === undefined || to === null) {
                ...
                if (valuee === undefined || valuee === null) {
                    ...
                    success(function (data, status, headers, config) {
                        $("#loading").hide();
                        $scope.datafa = data; // ds mean data search
    ...
    $scope.submit13 = function (uid, firstname, from, to) {
            ...
            success(function (data, status, headers, config) {
                $("#loading").hide();
                $scope.dataxs = data; // ds mean data search
    ...
    $scope.motzerla = function (mohafza) {
        ...
        ///////////
        */
         $http.get('/api/reportuserssum').success(function (data, status, headers, config) {
             $scope.users0 = data;
             console.log(data);
         }).error(function (data, status, headers, config) {
             $("#loading").hide();
